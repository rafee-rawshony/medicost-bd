  ...
  return (
    <div className="container mx-auto p-4 md:p-6 lg:p-8">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-primary-dark mb-6 text-center">About MediCost BD</h1>
        <div className="text-lg text-gray-700 space-y-4">
            <p>
                Navigating healthcare costs in Bangladesh can be a challenging and opaque process. 
                <span className="font-semibold text-primary-dark"> MediCost BD</span> was created to bring clarity and transparency to this process, empowering patients to make informed decisions about their medical expenses.
            </p>
            <p>
            ...
            <p>
                We believe that financial preparedness is a crucial part of healthcare planning. With MediCost BD, you can plan your budget ahead of time, reducing financial stress and allowing you to focus on what matters most – your health.
            </p>
